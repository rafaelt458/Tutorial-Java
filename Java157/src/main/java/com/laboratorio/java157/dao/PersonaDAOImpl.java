package com.laboratorio.java157.dao;

import com.laboratorio.java157.model.Persona;
import com.laboratorio.jdbc.mapper.GenericRowMapper;
import com.laboratorio.jdbc.repository.GenericJDBC;
...
public class PersonaDAOImpl implements PersonaDAO {
    ...
    public PersonaDAOImpl(String tableName, GenericJDBC<Persona> personaJDBC) {
        this.tableName = tableName;
        this.personaJDBC = personaJDBC;
        this.genericRowMapper = new GenericRowMapper<>(Persona.class);
    }
